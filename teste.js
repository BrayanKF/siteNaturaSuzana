...
class Produto {
  ...
  function divAdicionarPedidos() {
    ...
    if (senha === "") {
        ...
        // Configurar os botões de excluir
        ...
        // Configurar os botões de editar
  ...
  function editarProduto(nomeProduto) {
      ...
      produtoEditado = produtos.find((produto) => produto.nome === nomeProduto);
    
      if (produtoEditado) {
          document.getElementById("nomeProduto").value = produtoEditado.nome;
          document.getElementById("precoProduto").value = produtoEditado.preco;
